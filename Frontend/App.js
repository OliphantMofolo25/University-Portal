...
import PRLClasses from './src/screens/prl/PRLClasses';
...
import PLClasses from './src/screens/pl/PLClasses';
...
function StudentTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Courses" component={StudentCourses} options={{ title: 'Browse Courses' }} />
...
function PRLTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Classes" component={PRLClasses} options={{ title: 'Classes' }} />
...
function PLTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Classes" component={PLClasses} options={{ title: 'Classes' }} />
