...
const PRLReviews = ({ navigation }) => {
  ...
  const handleAddFeedback = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to add feedback: ' + error.message);
    } finally {
      setSubmitting(false);
    }
  };
...
const styles = StyleSheet.create({
  ...
  reportTitleContainer: { flexDirection: 'row', alignItems: 'center', gap: 8, flex: 1 },
  reportTitle: { fontSize: 16, fontWeight: '600', color: COLORS.navy, flex: 1 },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
  statusText: { fontSize: 11, fontWeight: '600' },
  reportLecturer: { fontSize: 13, color: COLORS.textDark, marginBottom: 4 },
  reportDate: { fontSize: 12, color: COLORS.textLight, marginBottom: 8 },
  reportTopic: { fontSize: 13, color: COLORS.textDark, marginBottom: 10 },
  statsRow: { flexDirection: 'row', gap: 12, marginBottom: 12 },
  statChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: COLORS.navy + '08', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 12 },
  statChipText: { fontSize: 11, color: COLORS.textLight },
  feedbackContainer: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 6, backgroundColor: COLORS.success + '10', padding: 10, borderRadius: 12, marginBottom: 12 },
  feedbackLabel: { fontSize: 12, fontWeight: '500', color: COLORS.success },
  feedbackText: { fontSize: 12, color: COLORS.textDark, flex: 1 },
  
  actionButtons: { flexDirection: 'row', gap: 10, marginTop: 8 },
  actionButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 8 },
  reviewButton: { backgroundColor: COLORS.navy },
  editButton: { backgroundColor: '#2A3D6B' },
  ...
  modalSubtitle: { fontSize: 13, color: COLORS.textLight, marginBottom: 4 },
  modalLabel: { fontSize: 14, fontWeight: '500', color: COLORS.textDark, marginTop: 12, marginBottom: 8 },
  
  statusPicker: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  statusOption: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: COLORS.border, backgroundColor: COLORS.white },
  statusOptionSelected: { backgroundColor: COLORS.navy + '10' },
  statusOptionText: { fontSize: 11, fontWeight: '500', color: COLORS.textDark },
  
  feedbackInput: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 16, padding: 12, fontSize: 14, color: COLORS.textDark, textAlignVertical: 'top', minHeight: 100, marginVertical: 10 },
});
