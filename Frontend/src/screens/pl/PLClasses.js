            ...
            <ScrollView>
              ...
              <View style={styles.lecturerList}>
                {lecturers.map((lecturer) => (
                  <TouchableOpacity
                    key={lecturer.id}
                    style={[styles.lecturerOption, formData.lecturerId === lecturer.id && styles.lecturerOptionSelected]}
                    onPress={() => setFormData({ ...formData, lecturerId: lecturer.id })}
                  >
                    <Text style={[styles.lecturerOptionText, formData.lecturerId === lecturer.id && styles.lecturerOptionTextSelected]}>
...
const styles = StyleSheet.create({
  ...
  lecturerList: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  lecturerOption: { backgroundColor: COLORS.navy + '10', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20 },
  lecturerOptionSelected: { backgroundColor: COLORS.navy },
  lecturerOptionText: { fontSize: 12, color: COLORS.textDark },
  lecturerOptionTextSelected: { color: COLORS.white },
